...
import { Star, Shield, Clock, Calendar, ChevronRight, Award, Briefcase, Bookmark, Share2 } from 'lucide-react';
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-8">The expert you're looking for doesn't exist or has been removed.</p>
          <button 
            onClick={() => navigate('/')}
        ...
        <div className="bg-gray-50 py-4 border-b border-gray-100">
          <div className="container mx-auto px-6">
            <div className="flex items-center text-sm text-gray-500">
              <a href="/" className="hover:text-flyp transition-colors">Home</a>
              <ChevronRight size={16} className="mx-2" />
              <a href="/#experts" className="hover:text-flyp transition-colors">Experts</a>
              <ChevronRight size={16} className="mx-2" />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
              ...
              <div className="lg:col-span-2 animate-fade-in">
                ...
                <div className="mt-10">
                  ...
                  <p className="text-gray-700 leading-relaxed mb-8">{expert.bio}</p>
                  ...
                  <div className="space-y-4 mb-6">
                    <div className="flex gap-3">
                      ...
                      <div>
                        <h3 className="font-medium">Senior Advisor at GlobalFinance</h3>
                    ...
                    <div className="flex gap-3">
                      ...
                      <div>
                        <h3 className="font-medium">Ph.D. in Finance, Stanford University</h3>
                  ...
                  <div className="mb-6 pb-6 border-b border-gray-100">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div className="relative">
                        <input type="radio" id="duration-30" name="duration" className="peer absolute opacity-0 w-full h-full cursor-pointer z-10" defaultChecked />
                        <label 
                          htmlFor="duration-30" 
                        ...
                        >
                          ...
                          <span className="text-sm">${(expert.price / 2).toFixed(0)}</span>
                        </label>
                      </div>
                      <div className="relative">
                        <input type="radio" id="duration-60" name="duration" className="peer absolute opacity-0 w-full h-full cursor-pointer z-10" />
                        <label 
                          htmlFor="duration-60" 
                          className="block text-center p-3 border border-gray-200 rounded-lg peer-checked:border-flyp peer-checked:bg-flyp-50 peer-checked:text-flyp transition-colors cursor-pointer"
                        >
                  ...
                  <div className="mb-6">
                    ...
                    <div className="flex overflow-x-auto space-x-2 pb-2">
                      {expert.availability.map((day, index) => (
                        <div key={index} className="min-w-[120px] border border-gray-200 rounded-lg p-3 hover:border-flyp transition-colors cursor-pointer">
                          <p className="text-center font-medium mb-2">
                            {new Date(day.date).toLocaleDateString('en-US', { weekday: 'short', month: 'short', day: 'numeric' })}
                          </p>
                          <p className="text-xs text-center text-gray-500">{day.slots.length} slots available</p>
                        </div>
                      ))}
                    </div>
                  </div>
